import{V as t}from"./chunks/theme.e2f260c3.js";import{C as c,o as r,c as i,k as s,a as n,H as a,w as E,l as d,Q as p}from"./chunks/framework.d26893dc.js";const e="/myNotes/assets/logo.d0201f7a.png",y=p(`<h1 id="markdown" tabindex="-1">Markdown <a class="header-anchor" href="#markdown" aria-label="Permalink to &quot;Markdown&quot;">​</a></h1><div class="warning custom-block"><p class="custom-block-title">更新时间</p><p>最近更新：2023-9-21</p><p>搭建版本：vitepress v1.0.0-rc.15</p></div><p>如果你还不了解 Markdown ，<a href="https://yiov.top/daily/markdown/" target="_blank" rel="noreferrer">请看我整理的Markdown教程</a></p><div class="tip custom-block"><p class="custom-block-title">说明</p><p>VitePress 相对于 VuePress 在Markdown中唯一的区别：链接可以直接渲染，不需要语法</p></div><h2 id="基础功能" tabindex="-1">基础功能 <a class="header-anchor" href="#基础功能" aria-label="Permalink to &quot;基础功能&quot;">​</a></h2><p>VitePress 使用 <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noreferrer">markdown-it</a> 作为解析器，并使用 <a href="https://shiki.matsu.io/" target="_blank" rel="noreferrer">Shiki</a> 来突出显示语言语法</p><p>基本配置</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#E1E4E8;">![</span><span style="color:#DBEDFF;text-decoration:underline;">LOGO</span><span style="color:#E1E4E8;">](</span><span style="color:#E1E4E8;text-decoration:underline;">/docs/public/logo.png</span><span style="color:#E1E4E8;">)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 相对路径，目标文件相对于本文章所在位置 --&gt;</span></span>
...
<span class="line"><span style="color:#24292e;">\`\`\`</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">:::</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>输出：</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-YAgZI" id="tab-JxigqIG" checked="checked"><label for="tab-JxigqIG">pnpm</label><input type="radio" name="group-YAgZI" id="tab-n7_oieP"><label for="tab-n7_oieP">yarn</label></div><div class="blocks"><div class="language-sh vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#查询pnpm版本</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;">&lt;!-- 相对路径 二选一--&gt;</span></span>
<span class="line"><span style="color:#24292E;">&lt;&lt;&lt; ./.vitepress/config.mts#fav{2}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>输出：</p><div class="language-mts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">mts</span><pre class="shiki github-dark has-highlighted-lines vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">head: [</span></span>
<span class="line highlighted"><span style="color:#e1e4e8;">  [&#39;link&#39;,{ rel: &#39;icon&#39;, href: &#39;/logo.png&#39;}],</span></span>
<span class="line"><span style="color:#e1e4e8;">],</span></span></code></pre><pre class="shiki github-light has-highlighted-lines vp-code-light"><code><span class="line"><span style="color:#24292e;">head: [</span></span>
<span class="line highlighted"><span style="color:#24292e;">  [&#39;link&#39;,{ rel: &#39;icon&#39;, href: &#39;/logo.png&#39;}],</span></span>
<span class="line"><span style="color:#24292e;">],</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="代码块嵌套" tabindex="-1">代码块嵌套 <a class="header-anchor" href="#代码块嵌套" aria-label="Permalink to &quot;代码块嵌套&quot;">​</a></h3><p>比如我们想展示代码块的写法，但是反引号已经用了</p><p>那么我们就用4个反引号 \`\`\`\` ，以此类推即可</p><div class="tip custom-block"><p class="custom-block-title">说明</p><p>这个使用方法，其实我在 <a href="https://yiov.top/daily/markdown/#%E4%BB%A3%E7%A0%81%E5%9D%97%E5%B5%8C%E5%A5%97" target="_blank" rel="noreferrer">Markdown教程</a> 里已经说过了</p></div><p>输入：</p><div class="language-md vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">\`\`\`\`</span></span>
<span class="line"><span style="color:#E1E4E8;">\`\`\`</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#24292E;">&lt;VPTeamMembers size=&quot;medium&quot; :members=&quot;members&quot; /&gt;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><p>输出：</p><div class="tip custom-block"><p class="custom-block-title">说明</p><p>尺寸大小有2个，<code>small</code> 和 <code>medium</code></p><p>看自己喜好吧，文档中一般是small</p></div>`,90),m=p(`<h3 id="创建完整页面" tabindex="-1">创建完整页面 <a class="header-anchor" href="#创建完整页面" aria-label="Permalink to &quot;创建完整页面&quot;">​</a></h3><p>你还可以创建完整的团队页面，而不是将团队成员添加到文档页面，这与创建自定义首页类似</p><div class="tip custom-block"><p class="custom-block-title">说明</p><p>要创建团队页面，首先创建一个新的 <code>md</code> 文件。 文件名并不重要，但这里我们将其命名为 <code>team.md</code></p></div><p>在此文件中，设置 <a href="./frontmatter.html#首页">frontmatter</a> 选项 <code>layout: page</code>，然后使用 TeamPage 组件构建页面结构</p><p>输入：</p><div class="language-md vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-highlighted-lines vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
